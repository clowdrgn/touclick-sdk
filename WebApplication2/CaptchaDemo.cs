...
namespace WebApplication2
{
    public class CaptchaDemo : IHttpHandler
    {
        ...
        private static string PUBKEY = "af7b946d-b653-4d7d-b045-b6964d8a668e";//公钥(从点触官网获取)
        private static string PRIKEY = "f67a91bc-64a1-4593-bf31-c2f7f08768fa";//私钥(从点触官网获取)
